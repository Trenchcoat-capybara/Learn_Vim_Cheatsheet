...
v           go to visual mode       when moving in visual mode it highlights between where you started and ended.\n
shift + v   visual line mode        visual mode covering the entire line.\n
...
ctrl+u  jump half page ud.\n

## Search motions
motions that move based on the character that follows it.\n

Motion  Usage
f       Move forward to (ft moves to the next t).\n
F       Move backwards to (Ft moves to the last t).\n
t       Move forward to just before (tf moves to before next f).\n
T       Move backwards to just before (Tf moves to the character before the last f).\n
...
p       Insert last deleted or yanked thing.\n
